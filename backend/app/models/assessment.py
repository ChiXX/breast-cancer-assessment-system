...
class Assessment(Base):
    ...
    action_required: Mapped[str] = mapped_column(String(100), nullable=True)
    ctcae_grade: Mapped[str] = mapped_column(String(20), nullable=True)
    ...
    display_text: Mapped[str] = mapped_column(Text, nullable=True)
