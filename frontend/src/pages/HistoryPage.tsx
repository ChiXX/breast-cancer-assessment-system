...
import { Calendar, ChevronRight, AlertCircle, Clock, SearchX } from 'lucide-react';
    ...
    <Layout>
      <div className="max-w-3xl mx-auto pt-12 px-4 animate-fade-in">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="bg-white px-4 py-2 rounded-full shadow-sm border border-gray-100 flex items-center gap-2 text-xs font-bold text-gray-400">
            <Clock size={14} />
            {data?.length || 0} 条记录
          </div>
        </div>
        ...
        {error ? (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0 pr-4">
                    ...
                    <p className="text-gray-800 font-medium truncate italic text-sm">
                      "{item.user_input}"
                    </p>
                  </div>
          ...
          <div className="text-center py-20 bg-gray-50/50 rounded-3xl border-2 border-dashed border-gray-200">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">暂无历史记录</h3>
            <p className="text-gray-500 mb-6">您还没有进行过症状评估</p>
            <Link
              to="/"
